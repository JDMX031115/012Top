...
$connent = connect();
$sqli = "select p.views, p.title,p.feature from posts p order by RAND() LIMIT 5;";
$boxxArr = query($connent, $sqli);
// $boxxArr = [];
// while ($row = mysqli_fetch_assoc($Optto)) {
//     $boxxArr[] = $row;
// }
// print_r($boxxArr)
?>
