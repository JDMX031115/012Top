    ...
    <div class="container-fluid">
      ...
      <form id="form" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="avata-src" type="hidden" name="avatar">
        ...
        <div class="form-group">
          <div class="col-sm-offset-3 col-sm-6">
            <input type="button" class="btn btn-primary" id="update" value="更新">
...
<script src="/static/assets/js/admin/_profile.js"></script>