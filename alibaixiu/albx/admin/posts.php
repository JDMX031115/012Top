    ...
    <div class="container-fluid">
      ...
      <div class="page-action">
        ...
        <form class="form-inline">
          ...
          <span class="btn btn-default btn-sm" id="filt" value="">筛选</span>
        </form>
...
<script type='text/template' id="tp">
    {{each $data value}}
      <tr postId="{{value.id}}">
        ...
        <td class="text-center">
          <a href="post-add.php?opt=edit?id={{value.id}}" class="btn btn-default btn-xs">编辑</a>
...
<script src="/static/assets/js/admin/_posts.js"></script>
